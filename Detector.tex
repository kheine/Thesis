...
\begin{figure}[!tp]
  \centering
  \begin{tabular}{c}
    \includegraphics[width=0.9\textwidth]{figures/cms_ecal_layout.pdf}
  \end{tabular}
...
\begin{figure}[!tp]
  \centering
  \begin{tabular}{c}
    \includegraphics[width=0.9\textwidth]{figures/fig_HCALdiagram.png}
  \end{tabular}
