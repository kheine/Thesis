...
\hypersetup{colorlinks=true,%
  ...
  linkcolor=black,%
  urlcolor=black}
\hypersetup{pdftitle={Quality of Jet Measurements and Impact on a Search for New Physics at CMS}}
...
\chapter{The Standard Model and Possible Extensions} \label{sec:Theory}
%\input{Theory.tex}
