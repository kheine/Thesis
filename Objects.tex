...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.91\textwidth]{figures/JEC.jpg} 
  \end{tabular}
...
\begin{figure}[!h]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/OffsetVsEta_NPV_PF5_data53_vs_mc53.pdf} 
  \end{tabular}
...
\begin{figure}[!h]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/ResComp_FSRcorr_residuals_Abseta_PF_DiJetData.pdf} 
  \end{tabular}
...
\end{description} 
In order to identify decays of boosted hadronic top quarks, as discussed above, several top tagging algorithms (or short \textit{taggers}) are commissioned within the CMS experiment~\cite{CMS-PAS-JME-13-007, CMS-DP-2014-036}. Two of them are used within this thesis:
\begin{description}
\begin{figure}[!tp]
  \centering 
  \begin{tabular}{cc}
