...
\chapter[Prospect Studies for a Search for Top Squarks]{Prospect Studies for a Search for Top Squarks in Events with Jets and Missing Transverse Momentum at $\sqrt{s}$ = 13 TeV} \label{chap:Stop}
\input{Stop.tex}
